...
- Create Angular project with ng: `ng new healthconnect.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`healthconnect.client.esproj`).
